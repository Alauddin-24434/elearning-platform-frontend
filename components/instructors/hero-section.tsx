...
export default function InstructorsHeroSection() {
  return (
    <section className="relative bg-primary-green text-white py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 items-center gap-8">
        <div className="space-y-6">
          <p className="text-lg font-semibold text-accent-yellow">Our instructors</p>
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">We help best performance.</h1>
