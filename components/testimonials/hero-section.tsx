  ...
  return (
    <section className="relative bg-primary-green text-white py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 space-y-6">
        <p className="text-lg font-semibold text-accent-yellow">Student's testimonial</p>
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">What our brilliant students are say.</h1>
